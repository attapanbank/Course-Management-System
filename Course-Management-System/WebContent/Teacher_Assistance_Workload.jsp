			...
			<div class="btn-group pull-right">
				<button class="btn btn-default dropdown-toggle"
					...
					<i class="glyphicon glyphicon-user"></i><span
						class="hidden-sm hidden-xs"> <%out.print(sFirstname);%>
	...
	<div class="ch-container">
		<div class="row">
					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<%
								...
								.equals(dateterm1_1))) {
								academicterm = "1";
								} else if ((today.before(dateterm2_2) || today.equals(dateterm2_2))
														...
														<table>
															<tr>
																<td><a
																	href="Teacher_Assistance_Confirm_Workload.jsp?userID=<%=strUserID%>&&year=<%=year2%>&&term=<%=semester2%>&&status=confirm"
																	class="btn btn-primary" data-dismiss="modal">Confirm</a></td>
																<td><a class="btn btn-danger examSurveybtn"
																	href="Teacher_Assistance_Reject_Comment_Workload.jsp?userID=<%=strUserID%>&&year=<%=year2%>&&term=<%=semester2%>"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form method="post" action="Teacher_Assistance_Workload_SetYear.jsp"
			...
			<p class="col-md-9 col-sm-9 col-xs-12 copyright">
				ÃÂ© <a href="http://usman.it" target="_blank">Muhammad Usman</a>
				2012 - 2014
			</p>
