							...
							<div class="box col-md-12">
								<div class="box-inner">
									...
									<div class="box-content">
										...
										<table
											...
											<tbody>
												<tr>
													<td>1</td>
													<td>1305205</td>
													<td class="center">Software Configuration Management</td>
													<td class="center">3 (3-0-6)</td>
													<td>SE55</td>
													<td class="center">50</td>
													<td><a class="btn btn-info"
														href="Admin_Course_Form.jsp"> <i
												...
												<tr>
													<td>2</td>
													<td>1302321</td>
													<td class="center">Object-Oriented Analysis and Design</td>
													<td class="center">3 (2-2-5)</td>
													<td>SE56</td>
										...
										<p align="center">
											<a class="btn btn-success" href="Admin_CoursePlan_Form.jsp">
												<i class="glyphicon glyphicon-edit icon-white"></i> Add
												Course Plan
											</a>
										</p>
									</div>
