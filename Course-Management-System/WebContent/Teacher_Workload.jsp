...
<li class="active"><a class="ajax-link" href="Teacher_Workload.jsp"><i class="glyphicon glyphicon-align-justify"></i><span> Workload</span></a></li>
            <li ><a class="ajax-link" href="Teacher_Course.jsp"><i class="glyphicon glyphicon-align-justify"></i><span> Course</span></a></li>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-star-empty"></i> Workload</h2>
    ...
    <tr role="row">
        ...
        <th style="width: 150px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting" aria-label="Status: activate to sort column ascending">Lec (Hour/Lec sec)
        </th>
         <th style="width: 150px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting" aria-label="Status: activate to sort column ascending">Lab(Hour/Leb)
        </th>
        <th style="width: 100px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting" aria-label="Actions: activate to sort column ascending">Hour/Week</th>
         <th style="width: 100px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting" aria-label="Actions: activate to sort column ascending">Workload/Week</th>
    </tr>
    </thead>
...
<td>
<div class="center" >
<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Commment if you not ok"></div></td>
<td><div class="center" ><a href="#" class="btn btn-primary" data-dismiss="modal">Comment</a></div></td>
</tr>
</table>
