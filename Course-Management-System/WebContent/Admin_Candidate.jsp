										...
										<table
											...
											<tbody>
												<tr>
													<td>
														<%
															out.print(rsUser.getString("user.firstname")+" "+ rsUser.getString("user.lastname"));
														%>
													</td>
													<td>
														<%
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form method="post" action="Admin_Workload_SetYear.jsp"
