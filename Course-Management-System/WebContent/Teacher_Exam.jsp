        ...
        <div class="nav-canvas">
          ...
          <ul style="" class="nav nav-pills nav-stacked main-menu">
            <li class="nav-header">Main</li>
             <li ><a class="ajax-link" href="Teacher_News.jsp"><i class="glyphicon glyphicon-home"></i><span> Dashboard</span></a>
                        </li>
...
<li ><a class="ajax-link" href="Teacher_Workload.jsp"><i class="glyphicon glyphicon-align-justify"></i><span> Workload</span></a></li>
            ...
            <li class="active"><a class="ajax-link" href="Teacher_Exam.jsp"><i class="glyphicon glyphicon-align-justify"></i><span> Examination</span></a></li>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-star-empty"></i> Examination</h2>
    ...
    <tbody aria-relevant="all" aria-live="polite" role="alert"><tr class="odd">
        ...
        <td class="center">
         ...
         <td class="center">Reason</td>
        <td class="center"><a href="#" class="btn btn-primary" data-dismiss="modal">Confirm</a></td>
