...
<script type="text/javascript">
	...
	function checkadduserform() {
		...
		if (!username || !oldpassword || !confirmpassword || !firstname || !lastname || !newpassword) {
			...
			alert("Username is not allow special characters.");
		} else if(/[^a-zA-Z0-9]/.test(newpassword)){
			alert("Password is not allow special characters.");
			...
			alert("Password must between 8-12 Characters");
		} else if (/\s/.test(username) || /\s/.test(newpassword)) {
			alert("Input cannot use white spaces");
		} else {
...
<body>
	...
	<%
		...
		String QueryString = "select * from user where userID like "+strUserID;
								...
								<form method="post" action="processChangePWD.jsp"
									...
									<div class="input-group col-md-6">
										<span class="input-group-addon"><i
											...
											type="text" id="firstname" name="firstname" value="<%= rs.getString("firstname") %>"
									...
									<div class="input-group col-md-6">
										<span class="input-group-addon"><i
											class="glyphicon glyphicon-pencil red"></i></span> <input
											type="text" id="lastname" name="lastname" value="<%= rs.getString("lastname") %>"
