			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div>
					<ul class="breadcrumb">
						...
						<li><a href="Admin_Setting.jsp">Setting</a></li>
					</ul>
				</div>
				...
				<div class="row">
					<div class="box col-md-6">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-cog"></i>&nbsp;&nbsp;Set date for
									semester
								</h2>
								<div class="box-icon">
							...
							<div class="box-content" align="center">
								...
								<%
									...
									if (rs.next()) {
										dateterm1_1 = rs.getString("dateterm1_1");
										dateterm1_2 = rs.getString("dateterm1_2");
										dateterm2_1 = rs.getString("dateterm2_1");
										dateterm2_2 = rs.getString("dateterm2_2");
									}
								%>

								<form method="post" action="Admin_Setting_AddDate.jsp"
									id="AddSemesterDateForm">
									<table>
										<tr>
											<td>Semester 1</td>
											<td><input type="date" id="dateterm1_1"
												name="dateterm1_1" value=<%=dateterm1_1%> /></td>
											<td>To</td>
											<td><input type="date" id="dateterm1_2"
												name="dateterm1_2" value=<%=dateterm1_2%> /></td>
										</tr>
										<tr>
											<td>Semester 2</td>
											<td><input type="date" id="dateterm2_1"
												name="dateterm2_1" value=<%=dateterm2_1%> /></td>
											<td>To</td>
											<td><input type="date" id="dateterm2_2"
												name="dateterm2_2" value=<%=dateterm2_2%> /></td>
										</tr>
									</table>

									<br> <input type="button" id=""
										onclick="checkdateforsemester()" class="btn btn-success"
										value="Save" />
								</form>
							</div>
						</div>
					...
					<!-- support ie and firefox for input type date -->
					...
					<script type="text/javascript">
						function checkdateforsemester() {
							var dateterm1_1 = new Date(document
									.getElementById("dateterm1_1").value);
							var dateterm1_2 = new Date(document
									.getElementById("dateterm1_2").value);
							var dateterm2_1 = new Date(document
									.getElementById("dateterm2_1").value);
							var dateterm2_2 = new Date(document
									.getElementById("dateterm2_2").value);

							if (dateterm1_1 >= dateterm1_2) {
								swal("You must set date in the left less than the right.");
							} else if (dateterm2_1 >= dateterm2_2) {
								swal("You must set date in the left less than the right.");
							} else if (dateterm1_2 >= dateterm2_1) {
								swal("You must set date for semester 2 more than semester 1");
							} else if (isNaN(dateterm1_1) || isNaN(dateterm1_2)
									|| isNaN(dateterm2_1) || isNaN(dateterm2_2)) {
								swal("Please fill all date before save.");
							} else {
								document.getElementById("AddSemesterDateForm")
										.submit();
							}
						}
					</script>
