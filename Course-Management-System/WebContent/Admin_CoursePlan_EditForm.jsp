...
<script type="text/javascript">
	function checkeditcourseplanform() {
		...
		if (!major) {
			...
			document.getElementById("EditcourseplanForm").submit();
		}
	}
</script>
			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div>
					<ul class="breadcrumb">
						...
						<li><a
							href="Admin_CoursePlan.jsp?year=<%=Year%>&term=<%=Term%>">Course
								Plan</a></li>
						<li>Course Plan Edit Form</li>
					</ul>
				</div>
						...
						<div class="box col-md-6">
							<div class="box-inner">
								...
								<div class="box-content" align="center">
									<form method="post"
										action="Admin_CoursePlan_EditInformation.jsp"
